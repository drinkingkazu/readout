...
#define  dma_buffer_size        40000000
  ...
  */
  ...
  case 7:
    ...
    ineu = 0;
    isuper = 0;
    printf("[0,1,2,3] for [pmt nu, pmt+tpc nu, pmt nu+sn, tpc nu+sn] \n");
    int readmode=99;
    scanf("%d", &readmode);
    if(readmode == 99)
      break;
    ...
    */
	...
	if(key == 'q') break;
      ...
      //
      //
      if(itrig_pulse == 1 && kazu_ctr%25==0) {
	imod = imod_trig;
	buf_send[0]=(imod<<11)+(mb_trig_p1_delay)+((p1_delay)<<16); // set up p1 delay;
	i=1;
	k=1;
...
#define  dma_buffer_size        10000000
  ...
  */
  ...
  imod=imod_fem;
  ichip=3;
  //buf_send[0]=(imod<<11)+(ichip<<8)+mb_feb_pmt_gate_size+(0x32<<16);  // set gate size (0x64 = 100 samples
  ...
  imod=imod_fem;
  ichip=3;
  //buf_send[0]=(imod<<11)+(ichip<<8)+mb_feb_pmt_gate1_size+(0x32<<16);  // set gate size (0x64 = 100)
