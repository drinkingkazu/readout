...
static int check_status(WDC_DEVICE_HANDLE hDevTPC,
  ...
  */
  ...
  case 7:
    ...
    */
    ...
    //if(check_status(hDev,imod_xmit_tpc+1, imod_st_tpc, imod_xmit_tpc))
    //break;
    check_status(hDev,imod_xmit_tpc+1, imod_st_tpc, imod_xmit_tpc);
	...
	if(check_status(hDev, imod_xmit_tpc+1, imod_st_tpc, imod_xmit_tpc) && respect_status)
	  break;
      }
